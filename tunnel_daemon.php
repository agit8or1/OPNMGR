...
function establishTunnel($firewall_info) {
    ...
    // and we forward local port to firewall's web interface
    $ssh_cmd = "ssh -N -T -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null " .
               "-o ServerAliveInterval=60 -o ServerAliveCountMax=3 " .
               "-L $tunnel_port:127.0.0.1:443 root@$wan_ip";
...
function testTunnelConnection($port) {
    ...
    curl_setopt_array($ch, [
        CURLOPT_URL => "https://127.0.0.1:$port",
