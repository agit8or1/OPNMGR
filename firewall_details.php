            ...
            <div class="card card-dark">
                <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?php if (isset($agents['update'])): 
                                            ...
                                            $status_dot = $update['status'] === 'online' ? '●' : '○';
                                        ?>
                                        ...
                                        <div class="mb-3" style="background-color: rgba(108,117,125,0.15); padding: 0.75rem; border-radius: 0.25rem; border-left: 3px solid #6c757d;">
                                            <strong class="text-white"><span class="text-warning">○</span> Update Agent:</strong><br>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card card-ghost p-4 border border-secondary">
                                <h6 class="text-white fw-bold mb-3" style="font-size: 1.1rem;">🔐 Secure Connection</h6>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-2">
                                            <strong class="text-white">Connection Type:</strong>
                                            <span class="text-light">On-Demand Reverse Tunnel</span>
                                        </div>
                                        <div class="mb-2">
                                            <small class="text-muted">
                                                <i class="fas fa-info-circle me-1"></i>
                                                Secure SSH tunnel established on-demand. No exposed ports.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <?php if (isset($agents['primary']) && $agents['primary']["status"] == "online"): ?>
                                            ...
                                            <div id="tunnel-status-<?php echo $firewall["id"]; ?>" class="mt-2" style="display:none;">
                                                <small class="text-info">
                                                    <i class="fas fa-spinner fa-spin me-1"></i>Establishing tunnel...
                                                </small>
                                            </div>
                                        <?php else: ?>
        ...
        .then(data => {
            ...
            if (data.success && data.commands && data.commands.length > 0) {
                ...
                data.commands.forEach(cmd => {
                    ...
                    let outputButton = '';
                    if (cmd.result && cmd.result.length > 7) { // More than just "success"
                        ...
                        outputButton = '<small class="text-muted">No output</small>';
                    }
...
function deployUpdateAgent() {
    if (!confirm('Deploy the failsafe update agent to this firewall?\n\nThe update agent:\n• Checks in every 30 minutes\n• Can update the primary agent\n• Restarts primary agent if it crashes\n• Cannot be updated remotely (manual SSH only)')) {
        return;
    }
