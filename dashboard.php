                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="card card-ghost">
                                <div class="card-header">
                                    <h6 class="mb-0 text-light">Quick Actions</h6>
                                </div>
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        <a href="/firewall_add.php" class="btn btn-primary">
                                            <i class="fas fa-plus-circle me-2"></i>Add New Firewall
                                        </a>
                                        <a href="/customers.php" class="btn btn-outline-primary">
                                            <i class="fas fa-users me-2"></i>Manage Customers
                                        </a>
                                        <a href="/manage_tags_ui.php" class="btn btn-outline-primary">
