...
[![v3.63.2](https://img.shields.io/badge/version-3.63.2-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.63.2 | Install from `main`. |
...
CI enforces these against `VERSION` and the published artifact — application 3.63.2,
