...
[![v3.76.1](https://img.shields.io/badge/version-3.76.1-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.76.1 | Install from `main`. |
...
CI enforces these against `VERSION` and the published artifact — application 3.76.1,
