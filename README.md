...
[![v3.68.1](https://img.shields.io/badge/version-3.68.1-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.68.1 | Install from `main`. |
| Agent | v1.6.9 | Newest published package. Not in this repo — see Known limitations. |
...
CI enforces these against `VERSION` and the published artifact — application 3.68.1,
**Agent**: v1.6.9 — so no reference in the tree can drift out of step.
