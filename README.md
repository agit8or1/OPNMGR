...
[![v3.46.0](https://img.shields.io/badge/version-3.46.0-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.46.0 | Install from `main`. |
| Agent | v1.6.2 | Newest published package. Not in this repo — see Known limitations. |
...
CI enforces these against `VERSION` and the published artifact — application 3.46.0,
