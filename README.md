...
[![v3.26.1](https://img.shields.io/badge/version-3.26.1-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.26.1 | Install from `main`. |
...
CI enforces these against `VERSION` and the published artifact — application 3.26.1,
