...
[![v3.49.0](https://img.shields.io/badge/version-3.49.0-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.49.0 | Install from `main`. |
| Agent | v1.6.6 | Newest published package. Not in this repo — see Known limitations. |
...
CI enforces these against `VERSION` and the published artifact — application 3.49.0,
**Agent**: v1.6.6 — so no reference in the tree can drift out of step.
