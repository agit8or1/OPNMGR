...
[![v3.47.0](https://img.shields.io/badge/version-3.47.0-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.47.0 | Install from `main`. |
| Agent | v1.6.5 | Newest published package. Not in this repo — see Known limitations. |
...
CI enforces these against `VERSION` and the published artifact — application 3.47.0,
**Agent**: v1.6.5 — so no reference in the tree can drift out of step.
