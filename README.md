...
[![v3.41.0](https://img.shields.io/badge/version-3.41.0-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.41.0 | Install from `main`. |
...
CI enforces these against `VERSION` and the published artifact — application 3.41.0,
