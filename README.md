...
[![v3.24.0](https://img.shields.io/badge/version-3.24.0-blue)](CHANGELOG.md)
...
**[See all 16 screenshots →](docs/SCREENSHOTS.md)** — the fleet list, search, customers
and sites, health overview, backup history, bulk operations, maintenance windows, staff
roles, the audit log and the light theme.
...
| | Version | Notes |
|---|---|---|
| Application | 3.24.0 | Install from `main`. |
...
CI enforces these against `VERSION` and the published artifact — application 3.24.0,
