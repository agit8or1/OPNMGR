...
[![v3.39.0](https://img.shields.io/badge/version-3.39.0-blue)](CHANGELOG.md)
...
| | Version | Notes |
|---|---|---|
| Application | 3.39.0 | Install from `main`. |
...
CI enforces these against `VERSION` and the published artifact — application 3.39.0,
**Agent**: v1.6.3 — so no reference in the tree can drift out of step.
