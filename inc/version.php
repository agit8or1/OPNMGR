...
if (!defined('APP_VERSION_DATE')) { define('APP_VERSION_DATE', '2026-02-15'); }
if (!defined('APP_VERSION_NAME')) { define('APP_VERSION_NAME', 'Login Branding Fix & Obfuscated Screenshots'); }
