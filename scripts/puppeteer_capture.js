...
const USERNAME = process.env.SCREENSHOT_USERNAME || 'screenshot';
const PASSWORD = process.env.SCREENSHOT_PASSWORD;
const BASE_URL = process.env.APP_URL || 'http://localhost';
const OUTPUT_DIR = process.env.SCREENSHOT_OUTPUT_DIR || '/var/www/opnmanager-website/assets/images';

// Validate required configuration
if (!PASSWORD) {
    console.error('ERROR: SCREENSHOT_PASSWORD environment variable not set');
    console.error('Please set SCREENSHOT_PASSWORD in your .env file or environment');
    process.exit(1);
}
