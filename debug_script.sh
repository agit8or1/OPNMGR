...
# Generated on 2025-09-11 02:28:57
...
curl -s -X POST -d "token=enroll_1757557603_6c74e69c&hostname=$HOSTNAME&wan_ip=$WAN_IP&lan_ip=$LAN_IP&ipv6_address=$IPV6_ADDRESS&opnsense_version=$OPNSENSE_VERSION" "https://opn.agit8or.net/api/enroll.php" > /dev/null 2>&1
