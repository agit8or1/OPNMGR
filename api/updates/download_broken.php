...
echo json_encode([
    ...
    'checksum' => md5(json_encode($update_data)),
    'instructions' => [
        'Apply files in the order provided',
        'Execute SQL statements after file updates',
...
/**
 * Verify instance authorization (mock function)
 * In production, this would check against a database of authorized instances
 */
function verify_instance_authorization($instance_id) {
    // Mock authorized instances
    ...
    return in_array($instance_id, $authorized_instances);
}
?>