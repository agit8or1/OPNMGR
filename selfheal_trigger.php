...
try {
    $pdo = new PDO("mysql:host=localhost;dbname=opnsense_fw", "root", "Qjr94@4wX$7sP2Kv");
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    
    $stmt = $pdo->prepare("INSERT INTO agent_selfheal_log (hostname, status, details, agent_version) VALUES (?, ?, ?, ?)");
